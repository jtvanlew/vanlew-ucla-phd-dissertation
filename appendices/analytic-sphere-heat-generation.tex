...
Because of the non-homegeneous form of the energy equation (due to the heat generation term), we will solve \Cref{eq:transformed-energy} by breaking it up into two simpler problems, 
...
Applying \Cref{eq:transformed-bc-2} directly gives $C_2 = 0$ and, with some algebra \Cref{eq:transformed-bc-1} gives, 
...
This is a standard homogeneous partial differential equation. The solution is of the form
...
% \Cref{eq:eigenfunction-coefficients} is also inserted back into \Cref{eq:eigen-initial-condition},
...
The eigenfunctions for \Cref{eq:eigen-function} are
...
We substitute the coefficients of \Cref{eq:eigenfunction-coefficients}, they can be substituted back into \Cref{eq:eigen-general-solution} and we have a solution for the homogeneous, transient distribution,
...
The complete solution is then a superposition of \Cref{eq:transformed-steady-state-solution} and \Cref{eq:transformed-transient-solution},
...
We will want to compare the solution of \Cref{eq:temperature-solution} to that of a sphere with the lumped capacitance assumption. To facilitate comparison, we look to a measure of the energy of the sphere (with radial dependence removed \textit{via} integration of \Cref{eq:temperature-solution}). The energy will be nondimensionalized as,
