...
\subsubsection{Natural convection in porous media}
Natural convection is a concern in fusion packed beds due to exceptionally high temperature gradients, adverse to the gravity vector, that arise in some configurations of packed beds. The issue of natural convection has been addressed in \Cref{sec:natural-convection}. The conclusion is that, in spite of temperature gradients as high as \SI{400}{\kelvin\per\centi\meter}, viscous forces in the porous media dominate any buoyant forces that might arise in ceramic breeders. Therefore, natural convection is not considered for modeling in this thesis.
