...
In \cref{sec:introduction}, I described generically how thermally-induced stress arises in the ceramic breeder volume. Research efforts have been aimed at developing an understanding and characterization of the thermomechanics of ceramic breeder pebble beds. Such an understanding is essential to providing confidence in the performance and lifetime of a ceramic breeder blanket design. In particular, a significant effort of the pebble bed thermomechanics study is on the development of modeling simulation tools. We will describe, in brief, some of the major experimental findings as they relate to the modeling efforts for ceramic pebble beds.
...
\begin{figure}[t!]
	\centering
	\includegraphics[width=\singleimagewidth]{chapters/figures/Fig-1}
...
\begin{figure}[t!]
	\centering
	\includegraphics[width=\singleimagewidth]{chapters/figures/Fig-2}
...
\subsection{DEM for Tritium Breeders}
...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=\singleimagewidth]{chapters/figures/1-s2.0-S092037960700049X-gr1.jpg}
...
\begin{figure}[!ht]
  \centering
\includegraphics[width=\singleimagewidth]{chapters/figures/Fig-4}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=\singleimagewidth]{chapters/figures/Fig-5}
...
\begin{figure}[t!]
\centering
\includegraphics[width=\singleimagewidth]{chapters/figures/Fig-6}
...
\begin{figure}[t!]
\centering
\includegraphics[width=\singleimagewidth]{chapters/figures/Fig-7}
...
\begin{figure}[t!]
\centering
\includegraphics[width=\singleimagewidth]{chapters/figures/Fig-8}
...
\end{figure}
 ...
 \begin{figure}[t!]
\centering
\includegraphics[width=\singleimagewidth]{chapters/figures/Fig-9}
...
\begin{figure}[t!]
\centering
\includegraphics[width=\singleimagewidth]{chapters/figures/Fig-10}
...
\subsection{Pebble Bed thermomechanics Summary \& Framework}
