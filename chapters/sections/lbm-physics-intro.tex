\subsection{Introduction to the Lattice-Boltzmann Method for Modeling}\label{sec:lbm-intro}
...
\subsubsection{Discretized Boltzmann Equation}
...
\subsubsection{Lattice Gas Automata}
