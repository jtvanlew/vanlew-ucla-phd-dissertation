...
# 368 nodes in X (call it Z in thesis)
...
for i in np.arange(df['y'].max()+1):
	...
	#xy_subset = y_subset.loc[y_subset['x'] == 368/2]
...
with open('y-profiles-filled.pkl', 'wb') as f:
...
pngFile = '../../figures/lbm/y-phi-v-profiles-filled.png'
plt.savefig(pngFile)
#~~~~~~~~~~ END Y PROFILES ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
# with open('z-profiles-filled.pkl', 'wb') as f:
#     pickle.dump([v, T, phi], f)

# with open('z-profiles-filled.pkl', 'rb') as f:
#     [v, T, phi] = pickle.load(f)
...
# for tl in ax2.get_yticklabels():
#     tl.set_color(color_idx[1])
# pngFile = '../../figures/lbm/z-phi-v-profiles-filled.png'
# plt.savefig(pngFile)
#~~~~~~~~~~ END Z PROFILES ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
T = np.mean(v) / df['velocity:0'].mean()
...
dP = (rho_lb_i-rho_lb_o)/(10*cs_squared) * dx**2 / dt**2
