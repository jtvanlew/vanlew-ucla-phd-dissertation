...
labels = [r'$\eta = 0.8$',r'$\eta = 0.6$',r'$\eta = 0.4$',r'$\eta = 0.3$',r'$\eta = 0.2$',r'$\eta = 0.1$',r'$\eta = 0.01$']
...
plt.legend(loc='best')
pngFile = 'irradiated-temperatures-cfd.png'
plt.savefig(pngFile)
